...
save_dir = "models/VGGNet/synme/{}_score".format(job_name)
# Directory which stores the snapshot of trained models.
snapshot_dir = "models/VGGNet/synme/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/synme/{}_score".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/data/synme/results/synme/{}_score/Main".format(os.environ['HOME'], job_name)
