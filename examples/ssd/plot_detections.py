...
if __name__ == "__main__":
    ...
    parser.add_argument("--imgdir", default='/lustre/home/lpwang/data/synme/gray-tex-images', 
            help = "A directory which contains the images.")
    parser.add_argument("--labelmap-file", default="/lustre/home/lpwang/ssd/data/synme/labelmap_synme.prototxt",
